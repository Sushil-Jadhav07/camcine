...
export function AccountPage() {
  ...
  const { continueWatching, fetchContinueWatching } = useWatchlistStore();
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3.5 glass-input rounded-xl text-white"
                    />
                  </div>
                  <div>
                    <label className="text-sm text-[var(--text-secondary)] mb-2 block">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3.5 glass-input rounded-xl text-white placeholder:text-[var(--text-muted)] resize-none"
                    />
                  </div>
              ...
              <div className="glass-card p-8 rounded-2xl">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <select className="w-full px-4 py-3.5 glass-input rounded-xl text-white">
