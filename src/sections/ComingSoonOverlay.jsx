...
export function ComingSoonOverlay({ backgroundImage = '/netflix.jpg' }) {
  return (
    <div className="absolute inset-0 z-50 flex min-h-screen items-start justify-center overflow-hidden bg-[var(--bg-base)] px-4 pb-24 pt-[18vh] md:pt-[16vh]">
      {backgroundImage ? (
        <img
          src={backgroundImage}
          alt=""
          className="absolute inset-0 h-full w-full scale-105 object-cover opacity-55 blur-md"
          aria-hidden="true"
        />
      ) : null}
      <div className="absolute inset-0 bg-black/62" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(6,8,10,0.12)_0%,rgba(6,8,10,0.7)_64%,rgba(6,8,10,0.95)_100%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(6,8,10,0.12)_0%,rgba(6,8,10,0.55)_48%,rgba(6,8,10,0.18)_100%)]" />
