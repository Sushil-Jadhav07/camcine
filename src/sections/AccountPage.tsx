                ...
                <div className="relative inline-block">
                  <div className="w-24 h-24 rounded-2xl overflow-hidden border-3 border-[var(--accent)]/30 mx-auto shadow-lg shadow-[var(--accent)]/10">
                    {user?.avatar ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[var(--accent)]/20 to-[#FF6B4A]/20">
                        <User className="w-10 h-10 text-[var(--accent)]" />
                      </div>
                    )}
                  </div>
                  <button className="absolute bottom-0 right-0 p-2 rounded-full bg-gradient-to-r from-[var(--accent)] to-[#FF6B4A] text-white hover:shadow-lg hover:shadow-[var(--accent)]/30 transition-all">
              ...
              <div className="space-y-6">
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <div className="flex items-center justify-between mb-5">
                    <span className="px-4 py-1.5 bg-gradient-to-r from-[var(--accent)] to-[#FF6B4A] text-white text-sm font-semibold rounded-full">{user?.subscription?.charAt(0).toUpperCase()}{user?.subscription?.slice(1)} Plan</span>
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <div className="h-2.5 bg-[var(--bg-elevated)] rounded-full overflow-hidden"><div className="h-full w-1/2 bg-gradient-to-r from-[var(--accent)] to-[#FF6B4A] rounded-full" /></div>
                </div>
